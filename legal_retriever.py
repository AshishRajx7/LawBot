...
class LegalRetriever:
    ...
    def retrieve(self, query: str, top_k: int = 5) -> Dict[str, Any]:
        ...
        # --- Stage 3: Dense Vector Search (Top 20) ---
        t0 = time.perf_counter()
        ...
        # --- Stage 4: Lexical BM25 Search (Top 20) ---
        t0 = time.perf_counter()
        ...
        # --- Stage 5: Candidate Merge & Deduplication ---
        t0 = time.perf_counter()
        candidate_map = {}
        ...
        # --- Stage 7: Metadata-Aware Weighted Fusion ---
        t0 = time.perf_counter()
        for c in candidates:
            did = c["doc_id"]
            ...
            if primary_class == "Doctrine Query" and c["doc_type"] == "ratio_chunk":
                meta_boost += 0.20 * retrieval_bias.get("ratio_boost", 1.0)
